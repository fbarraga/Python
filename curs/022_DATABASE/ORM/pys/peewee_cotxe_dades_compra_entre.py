...
bdd_cotxes.connect()
cad_data_i = input('Data de compra inicial? ')
cad_data_f = input('Data de compra final? ')
consulta_data = Propietat.select().where((Propietat.data_compra >= cad_data_i) & (Propietat.data_compra <= cad_data_f))
if consulta_data:
